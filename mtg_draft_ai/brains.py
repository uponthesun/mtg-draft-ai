...
class GreedySynergyPicker(Picker):
    ...
    def __init__(self, default_ratings, common_neighbors):
        ...
        Args:
            ...
            common_neighbors ({Card: {Card: List[Card]}}): Generated by _all_common_neighbors function
        """
    ...
    def factory(card_list):
        ...
        common_neighbors = _all_common_neighbors(syn_graph, card_list)
...
def _all_common_neighbors(graph, cards):
